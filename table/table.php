<?php 
    include('../config.php');
    session_start();
    $result = $db->query('SELECT p_id,firstname,lastname,address FROM task ORDER BY p_id DESC');
          ...
          <div class="card shadow">
            <div class="card-header border-0">
              <div class="row align-items-center">
				...
				<?php $apage = array('p_id'=>'','firstname'=>'');?>
                ...
                <!--<a data="<?php echo  $users->p_id ?>" title="print" onclick="window.print()"  class="tip  btn btn-info btn-sm "><span> <i class="fas fa-print"></i></span> </a>-->
				
				<div class="col text-right">
				<div id="example" class="btn btn-sm btn-primary"><i class="fas fa-print"></i>PDF</div>
                ...
                <?php if(isset($result) && ($data_record) > 0)  : $i=1; ?>
                    <?php  while ($users = mysqli_fetch_object($result)) { ?>
                        ...
                        <tr class="<?=$users->p_id?>_del">
                            ...
                            <a data="<?php echo  $users->p_id ?>" title="Delete <?php echo $users->firstname;?>" class="tip delete_check btn btn-info btn-sm "><span> <i class="fas fa-trash-alt"></i></span> </a>  
              ...
              <div class="row">
                <div class="col-sm-12">
                  <label>FirstName :</label>
                   <input type="firstname" name="firstname" id="firstname"  class="form-control" required="true">
                </div>
              </div>
            </div>
              ...
              <div class="row">
                <div class="col-sm-12">
                  <label>LastName :</label>
                   <input type="lastname" name="lastname" id="lastname"  class="form-control" required="true">
                </div>
              </div>
            </div>
